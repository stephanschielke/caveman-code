...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@juliusbrussee/caveman-tui";
...
export function getSettingsListTheme(): import("@juliusbrussee/caveman-tui").SettingsListTheme {
	return {
